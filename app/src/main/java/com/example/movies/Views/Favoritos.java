...
import com.example.movies.Views.MainView.AdapterRecycler;
import com.example.movies.Views.MainView.MainActivity;
...
public class Favoritos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        favoritos.fetchPopular(api_Key).enqueue(new Callback<PopularResponse>(){
