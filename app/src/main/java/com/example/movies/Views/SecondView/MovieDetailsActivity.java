package com.example.movies.Views.SecondView;
...
import com.example.movies.DataBase.DataBaseHelper;
...
public class MovieDetailsActivity extends AppCompatActivity {
    ...
    private static  final String api_Key= BuildConfig.MOVIES_KEY;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        favoriteBtn = findViewById(R.id.tb_favorites);
        ...
        details.fetchMovieItem(id, api_Key).enqueue(new Callback<MovieResponse>() {
            @Override
            public void onResponse(Call<MovieResponse> call, Response<MovieResponse> response) {
                ...
                favoriteBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if(favoriteBtn.getText()=="MAKE AS FAVORITE")
                        {
                ...
                Glide.with(MovieDetailsActivity.this).load(linkImage).into(imageView);
            ...
            public void onFailure(Call<MovieResponse> call, Throwable t) {
                Toast.makeText(MovieDetailsActivity.this, ":(", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void mostrarDados() {
        ...
        trailer.fetchTrailer(id, api_Key).enqueue(new Callback<TrailerResponse>() {
            @Override
            public void onResponse(Call<TrailerResponse> call, Response<TrailerResponse> response) {
                ...
                adapterRecycler = new AdapterRecyclerTrailers(MovieDetailsActivity.this, trailerResponse);
